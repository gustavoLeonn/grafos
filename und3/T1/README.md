...
explicação da modelagem do problema como grafo ponderado: Cada ponto do plano é um vértice do grafo e cada par de pontos forma uma aresta ponderada pela distância de Manhattan.
